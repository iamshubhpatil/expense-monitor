            ...
            <div class="space-y-3">
              <div
                ...
                :class="[
                  ...
                  String(alert.alert_type || '').toLowerCase() === 'exceeded'
                ...
                <div class="flex justify-between items-start">
                  <div>
                    <p class="font-semibold text-gray-900 dark:text-white">
                      {{ String(alert.alert_type || '').toLowerCase() === 'exceeded' ? '🚨 Budget Exceeded' : '⚠️ Budget Warning' }}
                    </p>
              ...
              >
                ...
                <div class="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    >
                      {{ (budget.percentage_used || 0) >= 100 ? 'Budget Exceeded' : (budget.percentage_used || 0) >= (budget.alert_threshold || 80) ? 'Budget Warning' : 'On Track' }}
                    </p>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    async markAlertRead(alertId) {
      try {
        await apiClient.put('/budgets/alerts/read', { id: alertId });
