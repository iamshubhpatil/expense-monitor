  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-lavender-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 py-8">
    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-4xl font-bold bg-gradient-to-r from-lavender-600 to-purple-600 bg-clip-text text-transparent mb-2">Welcome Back</h1>
        <p class="text-gray-600 dark:text-gray-400">Manage your finances with ease</p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 backdrop-blur-lg bg-opacity-95 dark:bg-opacity-95 border border-lavender-100 dark:border-lavender-900">
        ...
        <div v-if="errorMessage" class="mb-6 p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-xl">
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="font-semibold text-red-700 dark:text-red-400">Login failed</p>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-5">
          ...
          <div class="group">
            ...
            <div class="flex justify-end mt-2">
              <router-link 
                to="/forgot-password" 
                class="text-sm text-lavender-600 hover:text-lavender-700 dark:text-lavender-400 dark:hover:text-lavender-300 transition-colors"
              >
                Forgot Password?
              </router-link>
            </div>
        ...
        <div class="relative my-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-3 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400">New to ExpenseTracker?</span>
          </div>
        </div>
